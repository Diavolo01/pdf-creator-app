...
!function webpackUniversalModuleDefinition(t, e) {
    ...
    var __webpack_modules__ = [, (t, e) => {
        ...
        e.arraysToBytes = function arraysToBytes(t) {
            const e = t.length;
            if (1 === e && t[0]instanceof Uint8Array)
                return t[0];
            let s = 0;
            for (let n = 0; n < e; n++)
                s += arrayByteLength(t[n]);
            let n = 0;
        ...
        ;
        e.UnexpectedResponseException = class UnexpectedResponseException extends i {
            constructor(t, e) {
    ...
    , (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        if (_is_node.isNodeJS) {
            const {NodeCanvasFactory: t, NodeCMapReaderFactory: e, NodeStandardFontDataFactory: s} = __w_pdfjs_require__(20);
                ...
                case "url":
                    if ("undefined" != typeof window)
                        try {
                            ...
                            (0,
                            _util.warn)(`Cannot create valid URL: "${t}".`)
                        }
        ...
        class PDFDocumentLoadingTask {
            ...
            set onUnsupportedFeature(t) {
                (0,
                _display_utils.deprecated)("The PDFDocumentLoadingTask onUnsupportedFeature property will be removed in the future.");
                this.#e = t
            }
            get promise() {
        ...
        class PDFDocumentProxy {
            ...
            get stats() {
                (0,
                _display_utils.deprecated)("The PDFDocumentProxy stats property will be removed in the future.");
        ...
        class PDFPageProxy {
            ...
            getViewport({scale: t, rotation: e=this.rotate, offsetX: s=0, offsetY: n=0, dontFlip: i=!1}={}) {
            ...
            render({canvasContext: t, viewport: e, intent: s="display", annotationMode: n=_util.AnnotationMode.ENABLE, transform: i=null, canvasFactory: a=null, background: r=null, optionalContentConfigPromise: o=null, annotationCanvasMap: l=null, pageColors: c=null, printAnnotationStorage: h=null}) {
            ...
            getOperatorList({intent: t="display", annotationMode: e=_util.AnnotationMode.ENABLE, printAnnotationStorage: s=null}={}) {
                const n = this._transport.getRenderingIntent(t, e, s, !0);
                let i, a = this._intentStates.get(n.cacheKey);
                if (!a) {
                ...
                if (t.streamReader) {
                    ...
                    if (!s) {
                        ...
                        if (e instanceof _display_utils.RenderingCancelledException) {
                            ...
                            e.extraDelay > 0 && e.extraDelay < 1e3 && (s += e.extraDelay);
        ...
        class PDFWorker {
            ...
            constructor({name: t=null, port: e=null, verbosity: s=(0,
            ...
            static fromPort(t) {
                ...
                return this.#i.has(t.port) ? this.#i.get(t.port) : new PDFWorker(t)
            }
        ...
        class WorkerTransport {
            ...
            getRenderingIntent(t, e=_util.AnnotationMode.ENABLE, s=null, n=!1) {
                ...
                return {
                    renderingIntent: i,
                    cacheKey: `${i}_${_annotation_storage.AnnotationStorage.getHash(a)}`,
            ...
            setupMessageHandler() {
                ...
                t.on("GetReader", ( (t, e) => {
                    ...
                    ;
                    e.onPull = () => {
                        this._fullReader.read().then((function({value: t, done: s}) {
                            if (s)
                                e.close();
                            else {
                                (0,
                                _util.assert)((0,
                                _util.isArrayBuffer)(t), "GetReader - expected an ArrayBuffer.");
                ...
                t.on("GetRangeReader", ( (t, e) => {
                    ...
                    if (s) {
                        e.onPull = () => {
                            s.read().then((function({value: t, done: s}) {
                                if (s)
                                    e.close();
                                else {
                                    (0,
                                    _util.assert)((0,
                                    _util.isArrayBuffer)(t), "GetRangeReader - expected an ArrayBuffer.");
                                    e.enqueue(new Uint8Array(t), 1, [t])
                                }
                            }
                            )).catch((t => {
                ...
                t.on("StartRenderPage", (t => {
                    if (this.destroyed)
                        return;
                    this.#r.get(t.pageIndex)._startRenderPage(t.transparency, t.cacheKey)
                }
                ));
                t.on("commonobj", ( ([e,s,n]) => {
                    if (!this.destroyed && !this.commonObjs.has(e))
                        ...
                        case "Font":
                            ...
                            let a = null;
                            i.pdfBug && globalThis.FontInspector?.enabled && (a = {
                                registerFont(t, e) {
                ...
                t.on("DocStats", (t => {
                    this.destroyed || (this.#a = Object.freeze({
            ...
            getMetadata() {
                return this.#l ||= this.messageHandler.sendWithPromise("GetMetadata", null).then((t => ({
                    info: t[0],
        ...
        class InternalRenderTask {
            ...
            constructor({callback: t, params: e, objs: s, commonObjs: n, annotationCanvasMap: i, operatorList: a, pageIndex: r, canvasFactory: o, useRequestAnimationFrame: l=!1, pdfBug: c=!1, pageColors: h=null}) {
                this.callback = t;
                this.params = e;
                this.objs = s;
                this.commonObjs = n;
            ...
            initializeGraphics({transparency: t=!1, optionalContentConfig: e}) {
                ...
                const {canvasContext: s, viewport: n, transform: i, background: a} = this.params;
            ...
            cancel(t=null, e=0) {
                ...
                this.callback(t || new _display_utils.RenderingCancelledException(`Rendering cancelled, page ${this._pageIndex + 1}`,"canvas",e))
            }
            operatorListChanged() {
    ...
    , (t, e, s) => {
        ...
        class AnnotationStorage {
            ...
            remove(t) {
                ...
                if ("function" == typeof this.onAnnotationEditor) {
                    for (const t of this.#g.values())
                        if (t instanceof i.AnnotationEditor)
                            return;
                    this.onAnnotationEditor(null)
                }
            }
            ...
            getAll() {
                return this.#g.size > 0 ? (0,
                n.objectFromMap)(this.#g) : null
            }
            get size() {
                return this.#g.size
            }
    ...
    , (t, e, s) => {
        ...
        class AnnotationEditor {
            ...
            constructor(t) {
                ...
                const {rotation: e, rawDims: {pageWidth: s, pageHeight: n, pageX: a, pageY: r}} = this.parent.viewport;
                this.rotation = e;
    ...
    , (t, e, s) => {
        ...
        class CommandManager {
            ...
            add({cmd: t, undo: e, mustExec: s, type: n=NaN, overwriteIfSameType: i=!1, keepUndo: a=!1}) {
                s && t();
                if (this.#C)
                    return;
                const r = {
        ...
        class AnnotationEditorUIManager {
            ...
            addToAnnotationStorage(t) {
                t.isEmpty() || !this.#M || this.#M.has(t.id) || this.#M.setValue(t.id, t)
            }
            #Z() {
            ...
            #it(t) {
                Object.entries(t).some(( ([t,e]) => this.#K[t] !== e)) && this.#N.dispatch("annotationeditorstateschanged", {
                    source: this,
            ...
            registerEditorTypes(t) {
                if (!this.#O) {
                    ...
                    for (const t of this.#O)
                        this.#at(t.defaultPropertiesToUpdate)
                }
            }
            getId() {
                return this.#j.getId()
            ...
            updateToolbar(t) {
                t !== this.#B && this.#N.dispatch("switchannotationeditormode", {
                    source: this,
                    mode: t
                })
            }
    ...
    , (t, e, s) => {
        ...
        e.getCurrentTransformInverse = function getCurrentTransformInverse(t) {
            const {a: e, b: s, c: n, d: i, e: a, f: r} = t.getTransform().invertSelf();
            return [e, s, n, i, a, r]
        }
        ;
        ...
        ;
        e.setLayerDimensions = function setLayerDimensions(t, e, s=!1, n=!0) {
        ...
        async function fetchData(t, e=!1) {
            if (isValidFetchUrl(t, document.baseURI)) {
                ...
                return e ? new Uint8Array(await s.arrayBuffer()) : (0,
                i.stringToBytes)(await s.text())
            }
            return new Promise(( (s, n) => {
                ...
                a.onreadystatechange = () => {
                    if (a.readyState === XMLHttpRequest.DONE) {
                        if (200 === a.status || 0 === a.status) {
                            ...
                            i.stringToBytes)(a.responseText));
                            if (t) {
                                s(t);
                                return
                            }
        ...
        class PageViewport {
            constructor({viewBox: t, scale: e, rotation: s, offsetX: n=0, offsetY: i=0, dontFlip: a=!1}) {
                this.viewBox = t;
                this.scale = e;
                this.rotation = s;
                this.offsetX = n;
            ...
            clone({scale: t=this.scale, rotation: e=this.rotation, offsetX: s=this.offsetX, offsetY: n=this.offsetY, dontFlip: i=!1}={}) {
                return new PageViewport({
        ...
        e.StatTimer = class StatTimer {
            ...
            time(t) {
                t in this.started && (0,
                i.warn)(`Timer is already running for ${t}`);
                this.started[t] = Date.now()
            }
            timeEnd(t) {
                t in this.started || (0,
                i.warn)(`Timer has not been started for ${t}`);
                this.times.push({
                    name: t,
        ...
        function getRGB(t) {
            ...
            (0,
            i.warn)(`Not a valid color format: "${t}"`);
            return [0, 0, 0]
        }
    }
    , (t, e, s) => {
    ...
    , (t, e, s) => {
        ...
        e.FontLoader = class FontLoader {
            constructor({onUnsupportedFeature: t, ownerDocument: e=globalThis.document, styleElement: s=null}) {
                ...
                if (this.isFontLoadingAPISupported) {
                    ...
                    if (e) {
                        ...
                        try {
                            ...
                            (0,
                            n.warn)(`Failed to load font '${e.family}': '${s}'.`);
                            t.disableFontFace = !0;
                            throw s
                        }
                    }
                ...
                const {loadingRequests: e} = this
                  , s = {
                    ...
                    complete: function completeRequest() {
                        (0,
                        n.assert)(!s.done, "completeRequest() cannot be called twice.");
                        s.done = !0;
        ...
        e.FontFaceObject = class FontFaceObject {
            constructor(t, {isEvalSupported: e=!0, disableFontFace: s=!1, ignoreErrors: n=!1, onUnsupportedFeature: i, fontRegistry: a=null}) {
            ...
            getPathGenerator(t, e) {
                ...
                try {
                    ...
                    (0,
                    n.warn)(`getPathGenerator - ignoring character: "${t}".`);
    ...
    , (t, e, s) => {
        ...
        class CanvasExtraState {
            ...
            getPathBoundingBox(t=a.PathType.FILL, e=null) {
                ...
                if (t === a.PathType.STROKE) {
                    e || (0,
                    n.unreachable)("Stroke bounding box must include transform.");
        ...
        function getImageSmoothingEnabled(t, e) {
            ...
            s[0] = Math.fround(s[0]);
            s[1] = Math.fround(s[1]);
            const a = Math.fround((globalThis.devicePixelRatio || 1) * i.PixelsPerInch.PDF_TO_CSS_UNITS);
        ...
        class CanvasGraphics {
            constructor(t, e, s, n, {optionalContentConfig: i, markedContentStack: a=null}, r, o) {
                this.ctx = t;
            ...
            beginDrawing({transform: t, viewport: e, transparency: s=!1, background: n=null}) {
                ...
                if (this.foregroundColor && this.backgroundColor) {
                    ...
                    if ("#000000" === t && "#ffffff" === e || t === e || !s)
                        ...
                        const [s,a,r] = (0,
                        i.getRGB)(n)
                          , newComp = t => (t /= 255) <= .03928 ? t / 12.92 : ((t + .055) / 1.055) ** 2.4
                          , o = Math.round(.2126 * newComp(s) + .7152 * newComp(a) + .0722 * newComp(r));
                        this.selectColor = (s, n, i) => {
                            const a = .2126 * newComp(s) + .7152 * newComp(n) + .0722 * newComp(i);
                ...
                if (s) {
                    ...
                    i.getCurrentTransform)(this.compositeCtx))
                }
                this.ctx.save();
                ...
                i.getCurrentTransform)(this.ctx)
            }
            ...
            _scaleImage(t, e) {
                const s = t.width
                  , n = t.height;
                let i, a, r = Math.max(Math.hypot(e[0], e[1]), 1), o = Math.max(Math.hypot(e[2], e[3]), 1), l = s, c = n, h = "prescale1";
                for (; r > 2 && l > 1 || o > 2 && c > 1; ) {
                    let e = l
                      , s = c;
                    if (r > 2 && l > 1) {
            ...
            _createMaskCanvas(t) {
                ...
                if (!u) {
                    ...
                    i.getCurrentTransformInverse)(v));
                    u = u.img;
                    h && l && h.set(d, u)
                }
                v.imageSmoothingEnabled = getImageSmoothingEnabled((0,
                i.getCurrentTransform)(v), t.interpolate);
                drawImageAtIntegerCoords(v, u, 0, 0, u.width, u.height, 0, 0, s, r);
                v.globalCompositeOperation = "source-in";
                const E = n.Util.transform((0,
                i.getCurrentTransformInverse)(v), [1, 0, 0, 1, -S, -x]);
            ...
            beginSMaskMode() {
                ...
                const a = this.ctx;
                a.setTransform(...(0,
                i.getCurrentTransform)(this.suspendedCtx));
            ...
            constructPath(t, e, s) {
                ...
                for (let s = 0, i = 0, g = t.length; s < g; s++)
                    ...
                    case n.OPS.curveTo:
                        ...
                        r.updateCurvePathMinMax(d, o, l, e[i], e[i + 1], e[i + 2], e[i + 3], c, h, p);
                        i += 6;
                        break;
                    case n.OPS.curveTo2:
                        o = c;
                        ...
                        r.updateCurvePathMinMax(d, o, l, c, h, e[i], e[i + 1], e[i + 2], e[i + 3], p);
                        c = e[i + 2];
                        h = e[i + 3];
                        i += 4;
                        break;
                    case n.OPS.curveTo3:
                        ...
                        r.updateCurvePathMinMax(d, o, l, e[i], e[i + 1], c, h, c, h, p);
                        i += 4;
                        break;
            ...
            stroke(t=!0) {
                ...
                if (this.contentVisible)
                    if ("object" == typeof s && s?.getPattern) {
                        e.save();
                        e.strokeStyle = s.getPattern(e, this, (0,
                        i.getCurrentTransformInverse)(e), a.PathType.STROKE);
            ...
            fill(t=!0) {
                ...
                if (this.current.patternFill) {
                    e.save();
                    e.fillStyle = s.getPattern(e, this, (0,
                    i.getCurrentTransformInverse)(e), a.PathType.FILL);
                    n = !0
                }
            ...
            setFont(t, e) {
                ...
                0 !== i.fontMatrix[0] && 0 !== i.fontMatrix[3] || (0,
            ...
            get isFontSubpixelAAEnabled() {
                ...
                return (0,
                n.shadow)(this, "isFontSubpixelAAEnabled", s)
            }
            showText(t) {
                ...
                if (e.patternFill) {
                    ...
                    i.getCurrentTransformInverse)(o), a.PathType.FILL);
                    _ = (0,
                    i.getCurrentTransform)(o);
                    o.restore();
                    o.fillStyle = t
                }
                let y = e.lineWidth;
                ...
                if (0 === v || 0 === y) {
                    ...
                    t !== n.TextRenderingMode.STROKE && t !== n.TextRenderingMode.FILL_STROKE || (y = this.getSinglePixelWidth())
                } else
                    y /= v;
                if (1 !== l) {
                    o.scale(l, l);
            ...
            showType3Text(t) {
                ...
                if (!(s.textRenderingMode === n.TextRenderingMode.INVISIBLE) && 0 !== a) {
                    ...
                    for (p = 0; p < u; ++p) {
                        ...
                        if (!u) {
                            (0,
                            n.warn)(`Type3 character "${g.operatorListId}" is not available.`);
                            continue
                        }
                        if (this.contentVisible) {
            ...
            setStrokeRGBColor(t, e, s) {
                const i = this.selectColor?.(t, e, s) || n.Util.makeHexColor(t, e, s);
            ...
            _getPattern(t, e=null) {
                ...
                if (this.cachedPatterns.has(t))
                    ...
                    s = (0,
                    a.getShadingPattern)(this.objs.get(t));
            ...
            shadingFill(t) {
                ...
                e.fillStyle = s.getPattern(e, this, (0,
                i.getCurrentTransformInverse)(e), a.PathType.SHADING);
                const r = (0,
                i.getCurrentTransformInverse)(e);
                if (r) {
                    const t = e.canvas
                      , s = t.width
                      , i = t.height
            ...
            paintFormXObjectBegin(t, e) {
                if (this.contentVisible) {
                    ...
                    if (e) {
                        ...
                        i.getCurrentTransform)(this.ctx), e);
                        this.clip();
                        this.endPath()
                    }
                }
            ...
            beginGroup(t) {
                ...
                let a = n.Util.getAxialAlignedBoundingBox(t.bbox, (0,
                i.getCurrentTransform)(e));
            ...
            endGroup(t) {
                ...
                if (t.smask) {
                    ...
                    const s = n.Util.getAxialAlignedBoundingBox([0, 0, e.canvas.width, e.canvas.height], t);
            ...
            beginAnnotation(t, e, s, a, r) {
                ...
                if (Array.isArray(e) && 4 === e.length) {
                    ...
                    if (r && this.annotationCanvasMap) {
                        ...
                        e[2] = a;
                        e[3] = o;
                        const [r,l] = n.Util.singularValueDecompose2dScale((0,
                        i.getCurrentTransform)(this.ctx))
                ...
                if (n) {
                    void 0 === n.compiled && (n.compiled = function compileType3Glyph(t) {
                        ...
                        const n = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0])
                          , i = e + 1;
                        let a, r, o, l = new Uint8Array(i * (s + 1));
                        const h = e + 7 & -8;
            ...
            paintImageMaskXObjectGroup(t) {
                ...
                for (const r of t) {
                    ...
                    d.fillStyle = n ? s.getPattern(d, this, (0,
                    i.getCurrentTransformInverse)(e), a.PathType.FILL) : s;
                    d.fillRect(0, 0, o, l);
                    d.restore();
                    e.save();
                    e.transform(...c);
            ...
            paintInlineImageXObject(t) {
                ...
                n.scale(1 / e, -1 / s);
                let a;
                if ("function" == typeof HTMLElement && t instanceof HTMLElement || !t.data)
                    a = t;
                else {
                ...
                const r = this._scaleImage(a, (0,
                i.getCurrentTransformInverse)(n));
                n.imageSmoothingEnabled = getImageSmoothingEnabled((0,
                i.getCurrentTransform)(n), t.interpolate);
            ...
            paintInlineImageXObjectGroup(t, e) {
                ...
                for (const t of e) {
                    ...
                    s.scale(1, -1);
                    drawImageAtIntegerCoords(s, a.canvas, t.x, t.y, t.w, t.h, 0, -1, 1, 1);
                    s.restore()
                }
                this.compose()
            }
        ...
        for (const t in n.OPS)
            void 0 !== CanvasGraphics.prototype[t] && (CanvasGraphics.prototype[n.OPS[t]] = CanvasGraphics.prototype[t])
    }
    , (t, e, s) => {
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        class RadialAxialShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, s, a) {
                ...
                if (a === r.STROKE || a === r.FILL) {
                    const r = e.current.getClippedPathBoundingBox(a, (0,
                    i.getCurrentTransform)(t)) || [0, 0, 0, 0]
        ...
        function drawFigure(t, e, s) {
            ...
            case "triangles":
                for (a = 0,
                r = n.length; a < r; a += 3)
                    drawTriangle(t, s, n[a], n[a + 1], n[a + 2], i[a], i[a + 1], i[a + 2]);
                break;
            default:
        ...
        class MeshShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, s, a) {
                ...
                let o;
                if (a === r.SHADING)
                    o = n.Util.singularValueDecompose2dScale((0,
                    i.getCurrentTransform)(t));
                else {
                ...
                const l = this._createMeshCanvas(o, a === r.SHADING ? null : this._background, e.cachedCanvases);
                if (a !== r.SHADING) {
        ...
        class TilingPattern {
            ...
            clipBbox(t, e, s, n, a) {
                ...
                i.getCurrentTransform)(t.ctx), [e, s, n, a]);
                t.clip();
                t.endPath()
            }
    ...
    , (t, e, s) => {
        ...
        e.applyMaskImageData = function applyMaskImageData({src: t, srcPos: e=0, dest: s, destPos: i=0, width: a, height: r, inverseDecode: o=!1}) {
        ...
        e.MessageHandler = class MessageHandler {
            constructor(t, e, s) {
                ...
                this._onComObjOnMessage = t => {
                    ...
                    if (e.callbackId) {
                        ...
                        e.streamId ? this._createStreamSink(e) : n(e.data)
                }
                ;
            ...
            sendWithStream(t, e, s, i) {
                ...
                return new ReadableStream({
                    ...
                    cancel: t => {
                        (0,
                        n.assert)(t instanceof Error, "cancel must have a valid reason");
                        const e = (0,
                        n.createPromiseCapability)();
            ...
            _createStreamSink(t) {
                const e = t.streamId
                  ...
                  , d = {
                    ...
                    error(t) {
                        (0,
                        n.assert)(t instanceof Error, "error must have a valid reason");
                        if (!this.isCancelled) {
                            this.isCancelled = !0;
                            a.postMessage({
                                sourceName: s,
        ...
        e.OptionalContentConfig = class OptionalContentConfig {
            ...
            constructor(t) {
                ...
                if (null !== t) {
                    ...
                    for (const e of t.groups)
                        this.#gt.set(e.id, new OptionalContentGroup(e.name,e.intent));
                    if ("OFF" === t.baseState)
                        for (const t of this.#gt.values())
                            t._setVisible(a, !1);
                    for (const e of t.on)
                        this.#gt.get(e)._setVisible(a, !0);
                    for (const e of t.off)
                        this.#gt.get(e)._setVisible(a, !1);
            ...
            isVisible(t) {
                ...
                if ("OCG" === t.type) {
                    if (!this.#gt.has(t.id)) {
                        (0,
                        n.warn)(`Optional content group not found: ${t.id}`);
                        return !0
                    }
                ...
                if ("OCMD" === t.type) {
                    ...
                    (0,
                    n.warn)(`Unknown optional content policy ${t.policy}.`);
                    return !0
                }
                (0,
                n.warn)(`Unknown group type ${t.type}.`);
                return !0
            }
            setVisibility(t, e=!0) {
                if (this.#gt.has(t)) {
            ...
            getOrder() {
                return this.#gt.size ? this.#ft ? this.#ft.slice() : [...this.#gt.keys()] : null
            }
            getGroups() {
                return this.#gt.size > 0 ? (0,
                n.objectFromMap)(this.#gt) : null
            }
            getGroup(t) {
    ...
    , (t, e, s) => {
        ...
        e.PDFDataTransportStream = class PDFDataTransportStream {
            constructor(t, e) {
                (0,
                n.assert)(e, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.');
                this._queuedChunks = [];
            ...
            _onReceiveData(t) {
                ...
                if (void 0 === t.begin)
                    ...
                    (0,
                    n.assert)(s, "_onReceiveData - no `PDFDataTransportStreamRangeReader` instance found.")
                }
            }
    ...
    , (t, e, s) => {
        ...
        e.renderTextLayer = function renderTextLayer(t) {
            if (!t.textContentSource && (t.textContent || t.textContentStream)) {
                (0,
                i.deprecated)("The TextLayerRender `textContent`/`textContentStream` parameters will be removed in the future, please use `textContentSource` instead.");
        ...
        ;
        e.updateTextLayer = function updateTextLayer({container: t, viewport: e, textDivs: s, textDivProperties: n, isOffscreenCanvasSupported: a, mustRotate: r=!0, mustRescale: o=!0}) {
            r && (0,
            i.setLayerDimensions)(t, {
                rotation: e.rotation
            });
            if (o) {
                const t = getCtx(0, a)
        ...
        function layout(t) {
            const {div: e, scale: s, properties: n, ctx: i, prevFontSize: a, prevFontFamily: r} = t
              , {style: o} = e;
            let l = "";
        ...
        class TextLayerRenderTask {
            constructor({textContentSource: t, container: e, viewport: s, textDivs: a, textDivProperties: r, textContentItemsStr: o, isOffscreenCanvasSupported: l}) {
                ...
                const {pageWidth: c, pageHeight: h, pageX: d, pageY: u} = s.rawDims;
                this._transform = [1, 0, 0, -1, -d, u + h];
                this._pageWidth = c;
                this._pageHeight = h;
                (0,
                i.setLayerDimensions)(e, s);
            ...
            _processItems(t, e) {
                for (const s of t)
                    if (void 0 !== s.str) {
                        ...
                        null !== s.id && this._container.setAttribute("id", `${s.id}`);
                        t.append(this._container)
                    } else
                        "endMarkedContent" === s.type && (this._container = this._container.parentNode)
            }
            _layoutText(t) {
        ...
        class AnnotationEditorLayer {
            ...
            remove(t) {
                ...
                setTimeout(( () => {
                    ...
                    t.div.remove();
                    t.isAttachedToDOM = !1;
                    document.activeElement === document.body && this.#Ct.focusMainContainer()
                }
                ), 0);
            ...
            pointerup(t) {
                const {isMac: e} = n.FeatureTest.platform;
                if (!(0 !== t.button || t.ctrlKey && e) && t.target === this.div && this.#xt) {
                    this.#xt = !1;
            ...
            destroy() {
                this.#Ct.getActive()?.parent === this && this.#Ct.setActiveEditor(null);
                for (const t of this.#St.values()) {
                    this.#At?.removePointerInTextLayer(t.contentDiv);
                    t.setParent(null);
                    t.isAttachedToDOM = !1;
            ...
            render({viewport: t}) {
                ...
                (0,
                i.bindEvents)(this, this.div, ["dragover", "drop"]);
                for (const t of this.#Ct.getEditors(this.pageIndex))
                    this.add(t);
                this.updateMode()
            }
            update({viewport: t}) {
    ...
    , (t, e, s) => {
        ...
        class FreeTextEditor extends a.AnnotationEditor {
            ...
            static _keyboardManager = new i.KeyboardManager([[["ctrl+Enter", "mac+meta+Enter", "Escape", "mac+Escape"], FreeTextEditor.prototype.commitOrRemove]]);
            ...
            constructor(t) {
                ...
                this.#It = t.color || FreeTextEditor._defaultColor || a.AnnotationEditor._defaultLineColor;
            ...
            get propertiesToUpdate() {
                return [[n.AnnotationEditorParamsType.FREETEXT_SIZE, this.#jt], [n.AnnotationEditorParamsType.FREETEXT_COLOR, this.#It]]
            }
            #Ut(t) {
                const setFontsize = t => {
            ...
            getInitialTranslation() {
                ...
                return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#jt) * t]
            }
            rebuild() {
                super.rebuild();
            ...
            render() {
                ...
                this.enableEditing();
                FreeTextEditor._l10nPromise.get("editor_free_text2_aria_label").then((t => this.editorDiv?.setAttribute("aria-label", t)));
                FreeTextEditor._l10nPromise.get("free_text2_default_content").then((t => this.editorDiv?.setAttribute("default-content", t)));
                this.editorDiv.contentEditable = !0;
            ...
            serialize() {
                ...
                const t = FreeTextEditor._internalPadding * this.parentScale
                  , e = this.getRect(t, t)
                  , s = a.AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#It);
                return {
    ...
    , (t, e, s) => {
        ...
        class InkEditor extends i.AnnotationEditor {
            ...
            get propertiesToUpdate() {
                return [[n.AnnotationEditorParamsType.INK_THICKNESS, this.thickness || InkEditor._defaultThickness], [n.AnnotationEditorParamsType.INK_COLOR, this.color || InkEditor._defaultColor || i.AnnotationEditor._defaultLineColor], [n.AnnotationEditorParamsType.INK_OPACITY, Math.round(100 * (this.opacity ?? InkEditor._defaultOpacity))]]
            }
            #ne(t) {
            ...
            #he() {
                const {parentRotation: t, parentDimensions: [e,s]} = this;
                switch (t) {
                case 90:
                    return [0, s, s, e];
                case 180:
            ...
            #de() {
                const {ctx: t, color: e, opacity: s, thickness: n, parentScale: i, scaleFactor: a} = this;
                t.lineWidth = n * i / a;
                t.lineCap = "round";
                t.lineJoin = "round";
                t.miterLimit = 10;
            ...
            #ge(t, e) {
                ...
                if (1 !== this.currentPath.length)
                    i = (0,
                    a.fitCurve)(this.currentPath, 30, null);
                else {
                    const s = [t, e];
            ...
            render() {
                ...
                super.render();
                InkEditor._l10nPromise.get("editor_ink2_aria_label").then((t => this.div?.setAttribute("aria-label", t)));
            ...
            setDimensions(t, e) {
                const s = Math.round(t)
                  , n = Math.round(e);
                if (this.#te === s && this.#ee === n)
                    return;
                this.#te = s;
                this.#ee = n;
                this.canvas.style.visibility = "hidden";
                if (this.#Ht && Math.abs(this.#Ht - t / e) > .01) {
            ...
            #ye() {
                return this.#Kt ? Math.ceil(this.thickness * this.parentScale) : 0
            }
            #ae(t=!1) {
                if (this.isEmpty())
                    return;
            ...
            serialize() {
                ...
                return {
                    ...
                    paths: this.#ve(this.scaleFactor / this.parentScale, this.translationX, this.translationY, e),
                    pageIndex: this.pageIndex,
                    rect: t,
                    rotation: this.rotation
                }
    ...
    , t => {
        ...
        function generateAndReport(t, e, s, n, i, a) {
            ...
            r = function generateBezier(t, e, s, n) {
                var i, a, r, o, l, c, h, d, u, p, g, m, f, b, A, _, y, v = t[0], S = t[t.length - 1];
                i = [v, null, null, S];
    ...
    , (t, e, s) => {
        ...
        class AnnotationElement {
            ...
            _createContainer(t=!1) {
                ...
                const {pageWidth: r, pageHeight: o, pageX: l, pageY: c} = i.rawDims
                ...
                if (!t && e.borderStyle.width > 0) {
                    ...
                    i ? a.style.borderColor = n.Util.makeHexColor(0 | i[0], 0 | i[1], 0 | i[2]) : a.style.borderWidth = 0
                }
            ...
            get _commonActions() {
                const setColor = (t, e, s) => {
                    const n = s.detail[t];
                    s.target.style[e] = r.ColorConverters[`${n[0]}_HTML`](n.slice(1))
                }
                ;
                return (0,
            ...
            _renderQuadrilaterals(t) {
                for (const e of this.quadrilaterals)
                    e.className = t;
                ...
                if (this._fieldObjects) {
                    ...
                    if (i)
                        for (const {page: t, id: a, exportValues: r} of i) {
                            ...
                            n.warn)(`_getElementsByName - element not allowed: ${a}`)
                        }
                    return s
                }
                ...
                if (this._fieldObjects)
                    t.onclick = () => {
                        ...
                        for (const t of r) {
                            ...
                            s && (c.has(s) ? s.dispatchEvent(new Event("resetform")) : (0,
                ...
                if (this.renderForms) {
                    ...
                    if (this.enableScripting && this.hasJSActions) {
                        ...
                        s.addEventListener("keydown", (t => {
                            r.commitKey = 1;
                            let s = -1;
                            "Escape" === t.key ? s = 0 : "Enter" !== t.key || this.data.multiLine ? "Tab" === t.key && (r.commitKey = 3) : s = 2;
                            if (-1 === s)
                                return;
                        ...
                        s.addEventListener("blur", (t => {
                            ...
                            r.userValue = s;
                            r.lastCommittedValue !== s && this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
                                source: this,
                                detail: {
                                    id: e,
                                    name: "Keystroke",
                        ...
                        this._setEventListeners(s, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (t => t.target.value))
                    }
        ...
        class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
                ...
                if (this.enableScripting && this.hasJSActions) {
                    ...
                    this._setEventListeners(i, [["change", "Validate"], ["change", "Action"], ["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (t => t.target.checked))
                }
        ...
        class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
                ...
                const getValue = t => {
                    ...
                    return i ? Array.prototype.filter.call(s, (t => t.selected)).map((t => t[e])) : -1 === s.selectedIndex ? null : s[s.selectedIndex][e]
                }
                ;
                let r = getValue(!1);
                const getItems = t => {
                ...
                if (this.enableScripting && this.hasJSActions) {
                    n.addEventListener("updatefromsandbox", (s => {
                        const i = {
                            ...
                            insert(s) {
                                const {index: i, displayValue: a, exportValue: o} = s.detail.insert
                                  , l = n.children[i]
                    ...
                    this._setEventListeners(n, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"], ["input", "Action"]], (t => t.target.checked))
                } else
        ...
        class PopupAnnotationElement extends AnnotationElement {
            ...
            constructor(t) {
                const {data: e} = t;
                super(t, {
                    isRenderable: !PopupAnnotationElement.IGNORE_TYPES.has(e.parentType) && !!(e.titleObj?.str || e.contentsObj?.str || e.richText?.str)
                })
            }
            render() {
                this.container.className = "popupAnnotation";
                const t = this.layer.querySelectorAll(`[data-annotation-id="${this.data.parentId}"]`);
                if (0 === t.length)
                    return this.container;
                const e = new PopupElement({
                  ...
                  , r = i[1]
                  , {pageWidth: o, pageHeight: l, pageX: c, pageY: h} = this.viewport.rawDims;
            ...
            render() {
                ...
                if (s) {
                    const t = .7 * (255 - s[0]) + s[0]
                      , i = .7 * (255 - s[1]) + s[1]
                      , a = .7 * (255 - s[2]) + s[2];
                    e.style.backgroundColor = n.Util.makeHexColor(0 | t, 0 | i, 0 | a)
                }
        ...
        class FileAttachmentAnnotationElement extends AnnotationElement {
            ...
            render() {
                ...
                if (this.data.hasAppearance)
                    ...
                    t.src = `${this.imageResourcesPath}annotation-${/paperclip/i.test(this.data.name) ? "paperclip" : "pushpin"}.svg`
                }
        ...
        class AnnotationLayer {
            ...
            static render(t) {
                const {annotations: e, div: s, viewport: r, accessibilityManager: o} = t;
                (0,
                i.setLayerDimensions)(s, r);
                const l = {
                    data: null,
                    layer: s,
                    page: t.page,
                ...
                for (const t of e) {
                    ...
                    if (Array.isArray(i))
                        ...
                        i.style.zIndex = c++;
                        e instanceof PopupAnnotationElement ? s.prepend(i) : AnnotationLayer.#Te(i, t.id, s, o)
                    }
                }
              ...
              , createObjectURL = function(t, e="", s=!1) {
                ...
                for (let e = 0, s = t.length; e < s; e += 3) {
                    const a = 255 & t[e]
                      , r = 255 & t[e + 1]
                      , o = 255 & t[e + 2];
                    i += n[a >> 2] + n[(3 & a) << 4 | r >> 4] + n[e + 1 < s ? (15 & r) << 2 | o >> 6 : 64] + n[e + 2 < s ? 63 & o : 64]
                }
                return i
            }
              , u = function() {
                ...
                function encode(e, s, n, r) {
                    ...
                    const f = new Uint8Array([o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, l >> 24 & 255, l >> 16 & 255, l >> 8 & 255, 255 & l, c, h, 0, 0, 0])
            ...
            e.SVGGraphics = r = class {
                constructor(t, e, s=!1) {
                    ...
                    for (const t in i.OPS)
                        this._operatorIdMapping[i.OPS[t]] = t
                }
                getObject(t, e=null) {
                    return "string" == typeof t ? t.startsWith("g_") ? this.commonObjs.get(t) : this.objs.get(t) : e
                }
                ...
                executeOpTree(t) {
                    for (const e of t) {
                        ...
                        default:
                            (0,
                            i.warn)(`Unimplemented operator ${t}`)
                        }
                    }
                }
                setWordSpacing(t) {
                ...
                showText(t) {
                    ...
                    if (b === i.TextRenderingMode.FILL || b === i.TextRenderingMode.FILL_STROKE) {
                        ...
                        e.textRenderingMode === i.TextRenderingMode.ADD_TO_PATH ? e.tspan.setAttributeNS(null, "fill", "transparent") : e.tspan.setAttributeNS(null, "fill", "none");
                ...
                _makeTilingPattern(t) {
                    const e = t[1]
                      ...
                      , d = t[7]
                      , u = "shading" + m++
                      , [p,g,f,b] = i.Util.normalizeRect([...i.Util.applyTransform([a, r], n), ...i.Util.applyTransform([o, l], n)])
                ...
                constructPath(t, e) {
                    ...
                    for (const s of t)
                        ...
                        case i.OPS.rectangle:
                            ...
                            const t = n + e[o++]
                              , s = a + e[o++];
                            r.push("M", pf(n), pf(a), "L", pf(t), pf(a), "L", pf(t), pf(s), "L", pf(n), pf(s), "Z");
                            break;
                        case i.OPS.moveTo:
                            n = e[o++];
                            a = e[o++];
                        ...
                        case i.OPS.curveTo:
                            n = e[o + 4];
                            a = e[o + 5];
                            r.push("C", pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]), pf(n), pf(a));
                            o += 6;
                            break;
                        case i.OPS.curveTo2:
                            r.push("C", pf(n), pf(a), pf(e[o]), pf(e[o + 1]), pf(e[o + 2]), pf(e[o + 3]));
                            n = e[o + 2];
                            a = e[o + 3];
                            o += 4;
                            break;
                        case i.OPS.curveTo3:
                            n = e[o + 2];
                            a = e[o + 3];
                            r.push("C", pf(e[o]), pf(e[o + 1]), pf(n), pf(a), pf(n), pf(a));
                            o += 4;
                            break;
                        case i.OPS.closePath:
                            r.push("Z")
                ...
                setGState(t) {
                    for (const [e,s] of t)
                        ...
                        default:
                            (0,
                            i.warn)(`Unimplemented graphic state operator ${e}`)
                        }
                }
                fill() {
                    const t = this.current;
                ...
                paintImageXObject(t) {
                    const e = this.getObject(t);
                    e ? this.paintInlineImageXObject(e) : (0,
                    i.warn)(`Dependent image with object ID ${t} is not ready yet`)
                }
                paintInlineImageXObject(t, e) {
                    ...
                    r.setAttributeNS(null, "transform", `scale(${pf(1 / s)} ${pf(-1 / n)})`);
                ...
                paintImageMaskXObject(t) {
                    ...
                    if (e.bitmap) {
                        (0,
                        i.warn)("paintImageMaskXObject: ImageBitmap support is not implemented, ensure that the `isOffscreenCanvasSupported` API parameter is disabled.");
                        return
                    }
                    const s = this.current
                      , n = e.width
    ...
    , (t, e, s) => {
        ...
        e.PDFNodeStream = class PDFNodeStream {
            constructor(t) {
                ...
                this.url = function parseUrl(t) {
                    const e = l.parse(t);
                    if ("file:" === e.protocol || e.host)
                        return e;
                    if (/^[a-z]:[/\\]/i.test(t))
                        return l.parse(`file:///${t}`);
        ...
        class PDFNodeStreamFullReader extends BaseFullReader {
            constructor(t) {
                ...
                const handleResponse = e => {
                    ...
                    this._filename = (0,
                    i.extractFilenameFromHeader)(getResponseHeader)
                }
                ;
                this._request = null;
                "http:" === this._url.protocol ? this._request = r.request(createRequestOptions(this._url, t.httpHeaders), handleResponse) : this._request = o.request(createRequestOptions(this._url, t.httpHeaders), handleResponse);
        ...
        class PDFNodeStreamRangeReader extends BaseRangeReader {
            constructor(t, e, s) {
                ...
                ;
                this._request = null;
                "http:" === this._url.protocol ? this._request = r.request(createRequestOptions(this._url, this._httpHeaders), handleResponse) : this._request = o.request(createRequestOptions(this._url, this._httpHeaders), handleResponse);
                this._request.on("error", (t => {
                    this._storedError = t
                }
                ));
    ...
    , (t, e, s) => {
        ...
        e.extractFilenameFromHeader = function extractFilenameFromHeader(t) {
            ...
            if (e) {
                let t = (0,
                i.getFilenameFromContentDispositionHeader)(e);
                if (t.includes("%"))
                    try {
        ...
        ;
        e.validateRangeRequestCapabilities = function validateRangeRequestCapabilities({getResponseHeader: t, isHttp: e, rangeChunkSize: s, disableRange: n}) {
            const i = {
        ...
        e.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(t) {
            ...
            function rfc2047decode(t) {
                return !t.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(t) ? t : t.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (function(t, e, s, n) {
                    if ("q" === s || "Q" === s)
                        return textdecode(e, n = (n = n.replace(/_/g, " ")).replace(/=([0-9a-fA-F]{2})/g, (function(t, e) {
    ...
    , (t, e, s) => {
        ...
        class PDFNetworkStreamFullRequestReader {
            ...
            _onError(t) {
                this._storedError = (0,
                i.createResponseStatusError)(t, this._url);
        ...
        class PDFFetchStreamReader {
            constructor(t) {
                ...
                fetch(s, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((t => {
                    if (!(0,
                    i.validateResponseStatus)(t.status))
                        throw (0,
                        i.createResponseStatusError)(t.status, s);
        ...
        class PDFFetchStreamRangeReader {
            constructor(t, e, s) {
                ...
                fetch(r, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((t => {
                    ...
                    i.validateResponseStatus)(t.status))
                        throw (0,
                        i.createResponseStatusError)(t.status, r);
                    this._readCapability.resolve();
                    this._reader = t.body.getReader()
                }
    ...
    ( () => {
        ...
        if (c.isNodeJS) {
            ...
            (0,
            s.setPDFNetworkStreamFactory)((e => new t(e)))
        } else {
            const {PDFNetworkStream: t} = __w_pdfjs_require__(34)
              , {PDFFetchStream: e} = __w_pdfjs_require__(35);
            (0,
            s.setPDFNetworkStreamFactory)((s => (0,
            n.isValidFetchUrl)(s.url) ? new e(s) : new t(s)))
        }
    }
    )();
